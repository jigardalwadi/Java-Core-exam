...
public class Student {
	...
	public  int id;		//!important: id should be auto generated and should not be modifiable
	...
	public String toString() {
		return "Student [firstName=" + firstName + ", lastName=" + lastName + ", mailingAddress=" + mailingAddress
				+ ", permanentAddress=" + permanentAddress + "]";
	}*/

	@Override
	public String toString() {
		return "id =  " + id + " ," + "Student [firstName=" + firstName + ", lastName=" + lastName + ", mailingAddress=" + mailingAddress
				+ ", permanentAddress=" + permanentAddress + "]";
	}
